...
path('confirm-info/', views.confirm_info, name='confirm_info'),
    ...
    path('exams/<int:exam_id>/page/<int:page_number>/', views.exam_page, name='exam_page'),
    path('exams/save_answers/', views.save_answers, name='save_answers'),
    path('exams/next_page/<int:exam_id>/<int:page_number>/', views.next_page, name='next_page'),
    path('exams/save_page/<int:exam_id>/<int:page_number>/', views.save_page, name='save_page'),
