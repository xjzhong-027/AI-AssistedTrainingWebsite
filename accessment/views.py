...
from .models import Exam, StudentExamRecord, Page, StudentPageRecord, StudentAnswer, MediaMaterial, SubQuestion,MainQuestion,StudentMediaPlayRecord
...
def start_exam(request, exam_id):
    ...
    now = timezone.now()
    #latest_entry_time = exam.start_time + timezone.timedelta(minutes=30) #30分钟后无法进入 暂不设置
    latest_entry_time = exam.end_time
