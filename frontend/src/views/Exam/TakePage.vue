...
import { getExamById, startExam, getExamPage, saveAnswers, submitExam, getExamResult, updateMediaPlayRecord } from '@/api/exam'
...
/** 是否有可用的媒体地址（仅当已填写 media_url 时显示播放器） */
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // 提交接口需要传 unit_id（考试/任务包 ID），不是 exam_record_id
